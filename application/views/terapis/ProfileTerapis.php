                        ...
                        <div class="col-md-3">
                          <div style="border: 1px solid #c2c4c6; padding-left: 20px; padding-right: 20px; padding-top: 20px; padding-bottom: 20px;">
                            <div class="text-center">
                              <form method="post" accept-charset="utf-8" id="fotoForm" enctype="multipart/form-data" action="<?php echo site_url(); ?>/Terapis/editFotoTerapis">
                                <div>
      ...
      <script>
        $(document).ready(function(){
          ...
          $('#profileForm').on('submit', function(event){
            ...
            $.ajax({
             url:"<?php echo site_url(); ?>/Terapis/editProfileTerapis",
             method:"POST",
             data:$(this).serialize(),
             dataType:"json",
            //  beforeSend:function(){
          ...
          $('#passForm').on('submit', function(event){
            event.preventDefault();
            $.ajax({
             url:"<?php echo site_url(); ?>/Terapis/editPassTerapis",
             method:"POST",
             data:$(this).serialize(),
             dataType:"json",
            //  beforeSend:function(){
