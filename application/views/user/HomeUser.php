							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Malang</h3>
					...
					<div class="banner-form-w3 ml-lg-5">
						<div class="padding">
							<form action="#" method="post">
								<h5 class="mb-3">Search Our Spa</h5>
								<div class="form-style-w3layout">
								<input placeholder="Search Kategori" name="name" type="text" required="">
					            <input placeholder="Sesi" name="name" type="text" required="">
					            <input placeholder="Tanggal" name="name" type="text" required="">
    ...
    <div class="container py-md-5">
        ...
        <div class="row">
			<div class="team-grid col-lg-3 col-sm-6 mb-5">
				<img src="<?php echo base_url();?>assets/user/images/t1.jpg" class="" alt="" />
			...
			<div class="team-grid col-lg-3 col-sm-6  mb-5">
				<img src="<?php echo base_url();?>assets/user/images/t2.jpg" class="" alt="" />
				<div class="team-info text-center">
			...
			<div class="team-grid col-lg-3 col-sm-6  mb-5">
				<img src="<?php echo base_url();?>assets/user/images/t3.jpg" class="" alt="" />
				<div class="team-info text-center">
			...
			<div class="team-grid col-lg-3 col-sm-6  mb-5">
				<img src="<?php echo base_url();?>assets/user/images/t4.jpg" class="" alt="" />
				<div class="team-info text-center">
