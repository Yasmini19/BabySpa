   ...
   <div class="container-fluid" style="background-color:  #fff; padding-top: 100px;padding-bottom: 20px">
         <!--  <br><br>
          <div class="row">
            <div class="col-4">
              <div class="card" style="background-color: #161616;padding-top: 10px; padding-bottom: 10px; padding-left: 10px;box-shadow: 0 0px 0px rgba(0, 0, 0, 0);"><h2 class="text-white">My Profile&nbsp;</h2></div>
                </div>
              </div>
            </div>
          </div> -->
  ...
  <div class="container-fluid" style="padding-top: 20px; color: black">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <div>
          <img src="<?php echo base_url();?>assets/imgEvent/<?php echo $name[0]->foto?>" class="avatar img-circle" alt="avatar" width="150" height="150">
      ...
      <div style="border: 1px solid #c2c4c6; padding-left: 20px; padding-right: 20px; padding-top: 20px">
        ...
        <?php echo form_open_multipart('UserDetail/update'); ?>
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" name="name" type="text" value="<?php echo $name[0]->full_name?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Address:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" name="add" value="<?php echo $name[0]->alamat?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Phone Number:</label>
            <div class="col-lg-8">
              <input class="form-control" name="phone" type="text" value="<?php echo $name[0]->no_telp?>">
            </div>
          </div>
          <div class="form-group">
