                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($glry as $key => $value) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url("/Admin/edit_gallery/" . $value->id_galery) ?>" class="fas fa-edit" aria-hidden="true" data-toggle="modal" data-target="#modal-edit-gallery" name="tombolEditGallery" value="<?php echo $value->id_galery; ?>"></a>
                ...
                <div class="modal-content">
                    ...
                    <form method="post" accept-charset="utf-8" id="editGallery" enctype="multipart/form-data">
                                ...
                                <div class="md-form mb-4">
                                    ...
                                    <input type="file" id="edit_galery" class="form-control validate" name="edit_galery" placeholder="Input field">
    ...
    <script type="text/javascript">
        ...
        $('#searchTable').keyup(function() {
            ...
            if (text != '' || text != null) {
                ...
                $.ajax({
                    url: '<?php echo site_url('admin/search_gallery') ?>',
                    type: 'post',
                    data: {
                        text: text
                    },
        ...
        $('[name="tombolEditGallery"]').click(function() {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/get_gallery') ?>',
                type: 'post',
                data: {
                    id: id
                },
        ...
        //ajaxformedit
        $('form#editGallery').submit(function(e) {
            e.preventDefault();
            var formData = new FormData($('form#editGallery')[0]);

            $.ajax({
                url: '<?php echo site_url('admin/edit_gallery'); ?>',
                type: 'POST',
                data: formData,
        ...
        //ajaxdelete
      $('[name="tombolDeleteGallery"]').click(function(e){
        e.preventDefault();
        var id = $(this).attr('value')
        //alert(id);
        $.ajax({
          url: '<?php echo site_url('admin/delete_gallery') ?>',
          type: 'post',
          data: {id:id},
          success: function(response) {
            //alert(response);
