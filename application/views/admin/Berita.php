...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($brt as $key => $value) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url("/Admin/edit_berita/" . $value->id_berita) ?>" class="fas fa-edit" aria-hidden="true" data-toggle="modal" data-target="#modal-edit-berita" name="tombolEditBerita" value="<?php echo $value->id_berita; ?>"></a>
        ...
        <div class="modal fade" id="modal-edit-berita" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <!--Header-->
                    <div class="modal-header">
                    ...
                    <!--Body-->
                        <div class="modal-body">
                            <div class="modal-body mx-3">
                    <!-- <FORM id="addTerapis"> -->
                    <form method="post" accept-charset="utf-8" id="editBerita" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="edit_judul_berita" name="edit_judul_berita" class="form-control" placeholder="Judul Berita">
                                </div>
                               ...
                               <div class="md-form mb-4">
                                    ...
                                    <input type="file" id="edit_foto_berita" class="form-control validate" name="edit_foto_berita" placeholder="Input field">
        ...
        $('[name="tombolEditBerita"]').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#edit_id').val(data.id_berita);
                    $('#edit_judul_berita').val(data.judul_berita);
                    $('#edit_deskripsi').val(data.deskripsi);
                    
                    $('#foto_lama').attr('src', '<?php echo base_url() ?>/assets/upload/' + data.foto_berita);
                }
            });
        });
