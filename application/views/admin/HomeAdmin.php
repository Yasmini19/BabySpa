						...
						<div class="col-lg-4 mb-3 mb-lg-0">
							<div class="card congratulation-bg text-center">
								<div class="card-body pb-0">
									<img src="<?php echo base_url();?>assets/admin/images/dashboard/face29.png" alt="">  
											...
											<div class="row">
												...
												<div class="col-lg-4">
													<div class="position-relative">
														<img src="<?php echo base_url();?>assets/admin/images/dashboard/live.png" class="w-100" alt="">
