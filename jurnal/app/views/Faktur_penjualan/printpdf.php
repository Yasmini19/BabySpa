...
<body>
    ...
    <div class="header-map">
        ...
        <p class="text-left"><?php echo get_pengaturan('telepon') ?></p>
    </div>
            ...
            <table class="table table-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($tanggaltempo==null) $tanggaltempo="-"; else $tanggaltempo=formatdatemonthname($tanggaltempo)?>
                        <td class="font-weight-bold">: <?php echo $tanggaltempo ?></td>
                    </tr>
                    <tr>
        ...
        <div class="w-30">
            <table class="table table-sm">
                <tbody>
                    ...
                    <tr> <td class="text-center">&nbsp;</td> </tr>
                    <tr>
                        <td class="text-center font-weight-bold">Gentle Baby</td>
                    </tr>
                </tbody>
            </table>
        </div>
