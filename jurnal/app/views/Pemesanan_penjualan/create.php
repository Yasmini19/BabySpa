        ...
        <div class="card-body">
            <form action="javascript:save()" id="form1">
                ...
                <div class="mb-3 mt-3 table-responsive">
                    <div class="mt-3 mb-3" hidden id="btn_add_detail">
...
<script type="text/javascript">
    ...
    $(document).on('change','select[name=gudangid]',function(){
        var val = $(this).val();
        if(val) {
            $('#btn_add_detail').attr('hidden',false);
        } else {
            $('#btn_add_detail').attr('hidden',true);
        }
    })
    ...
    function save_detail() {
        ...
        if(formData.get('jumlah') == 0) {
            NotifyError('Jumlah tidak boleh kosong');
            return false;
        }
