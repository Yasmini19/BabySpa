    ...
    <div class="page-header-content header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <div class="btn-group">
                    <a href="{site_url}pembayaran_penjualan/printpdf" class="btn btn-primary">
                        <?php echo lang('print') ?>
                    </a>
                    <a href="{site_url}pembayaran_penjualan" class="btn btn-danger">
                        <?php echo lang('back') ?>
                    </a>
                </div>
            </div>
            ...
            <form action="javascript:save()" id="form1">
                ...
                <div class="row mt-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label><?php echo lang('acceptedby') ?>:</label>
                ...
                <div class="text-left">
                    <div class="btn-group">
                        <a href="{site_url}pembayaran_penjualan" class="btn bg-danger"><?php echo lang('cancel') ?></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title"><?php echo lang('Kredit Memo Tersedia') ?></h5>
            </div>

            <div class="modal-body">
                <h3 class="font-weight-bold m-3">Apakah Anda ingin menerapkan kredit memo terbaru ke Sales Invoice?</h3>
                <table class="table">
                    <tr>
                        <td><?php echo lang('supplier') ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo number_format($totalkreditmemo) ?></td>
                    </tr>
                    <tr>
            ...
            <div class="modal-footer">
                <div class="btn-group">
                    ...
                    <a href="{site_url}pembayaran_penjualan/create_memo?idfaktur={id}" class="btn btn-success"><?php echo lang('apply') ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var base_url = '{site_url}pembayaran_penjualan/';
    var totalkreditmemo = '{totalkreditmemo}';

    $(document).ready(function(){

        if(totalkreditmemo > 0) {
