        ...
        <div class="card-body">
			<form action="javascript:save()" id="form1">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="notrans" required placeholder="AUTO">
                        </div>
                        <div class="form-group">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('subtotal') ?>:</label> 
                            <input class="form-control subtotalhead" name="subtotalhead" disabled>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('discount') ?>:</label> 
                            <input class="form-control diskon" name="diskonhead">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control totalhead" name="totalhead" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">&nbsp;</div>
                    <div class="col-md-6">
