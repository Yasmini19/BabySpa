        ...
        <div id="requirements" class="step">
            <div class="subsection">
                <div class="section-title">1. PERSYARATAN KONFIGURASI PHP:</div>
            ...
            <div class="subsection">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="fw-700">/app/config/db_config.php</span></td>
                            <td class="status">
                                <?php if (is_writeable(ROOTPATH."/app/config/db_config.php")): ?>
                                    <span class="mdi mdi-check-circle color-green"></span>
                                <?php else: ?>
                                    <span class="mdi mdi-close-circle color-red"></span>
                                    <?php $installable = false; ?>
                        ...
                        <tr>
                            <?php 
                                if (!file_exists(ROOTPATH."/uploads/")) {
                                    @mkdir(ROOTPATH."/uploads/", "0777", true);
                                }
                            ?>
                            <td><span class="fw-700">/uploads/</span></td>
                            <td class="status">
                                <?php if (is_writeable(ROOTPATH."/uploads/")): ?>
                                    <span class="mdi mdi-check-circle color-green"></span>
                                <?php else: ?>
                                    <span class="mdi mdi-close-circle color-red"></span>
                                    <?php $installable = false; ?>
